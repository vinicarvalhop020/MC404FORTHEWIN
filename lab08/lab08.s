...
get_width:
    ...
    encontra_tamanho:
    li t1, 33 #valor do espaco em ascii
    blt s1, t1, encontra_numero
    addi t0, t0, 1  #t0 + 1
...
get_hight:
    ...
    add t0, t0, s0  #posicao 3 + s0 (onde come̤a o hight)
    mv t5, t0 #backup do come̤o de hight
...
main:
    #s3 contem width
    #s4 contem hight
    #t5 contem a ultima posicao de hight
    mv t0, t5 #t0 = fim de hight
...
print_image_canvas:
    ...
    li t1, 0
    li t2, 0
    addi t0, t0, 6 #< epa̤o + 255 + espa̤o = 5
    add s0, a1, t0 # s0 <= &input + t0

for_linhas:
bge t1, s3, exit #le at̩ t1 == largura

    for_colunas:
        bge t2, s4, atualiza_linha #le at̩ t2 == altura 

        set_pixel:
            mv a0, t2 # x coordinate = 100 linha
            mv a1, t1 # y coordinate = 200 coluna
