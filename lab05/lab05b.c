...
void inst_to_hex(InstData *data){

    if (data->type == 0)
    {
        int maskupcode = 0b00000000000000000000000001111111;
        int maskrd =     0b00000000000000000000000000011111;
        int maskfunc3 =  0b00000000000000000000000000000111;
        int maskrs1   =  0b00000000000000000000000000011111;
        int maskrs2   =  0b00000000000000000000000000011111;
        int maskfunc7 =  0b00000000000000000000000001111111;

        int vetor = ((data->opcode & maskupcode) | ((data->rd & maskrd) << 7) | ((data->funct3 & maskfunc3) << 12) | ((data->rs1 & maskrs1) << 15) | ((data->rs2 & maskrs2)) << 20 | ((data->funct7 & maskfunc7) << 25));
        hex_code(vetor);
    }
    ...
    if  (data->type == 1)
    {
        ...
        int maskfunc3 =  0b00000000000000000000000000000111;
        int maskrs1   =  0b00000000000000000000000000011111;
        int maskimm =    0b00000000000000000000111111111111;

        int vetor = ((data->opcode & maskupcode) | ((data->rd & maskrd) << 7) | ((data->funct3 & maskfunc3) << 12) | ((data->rs1 & maskrs1) << 15) | ((data->imm & maskimm) << 20));
        hex_code(vetor);
    }
    ...
    {
        int maskupcode =     0b00000000000000000000000001111111;
        int maskimm1  =      0b00000000000000000000000000011111;
        int maskfunc3 =      0b00000000000000000000000000000111;
        int maskrs1   =      0b00000000000000000000000000011111;
        int maskrs2   =      0b00000000000000000000000000011111;
        int maskimm2  =      0b00000000000000000000111111100000;

        int vetor = ((data->opcode & maskupcode) | ((data->imm & maskimm1) << 7) | ((data->funct3 & maskfunc3) << 12) | ((data->rs1 & maskrs1) << 15) | ((data->rs2 & maskrs2) << 20) | ((data->imm & maskimm2) << 20));
        hex_code(vetor);
    }
...

    {
        ...
        int maskrs1   =   0b00000000000000000000000000011111;
        int maskrs2   =   0b00000000000000000000000000011111;
        int maskimm1  =   0b00000000000000000000100000000000; //imm[11]
        int maskimm2  =   0b00000000000000000000000000011110; //imm[4:1]
        int maskimm3  =   0b00000000000000000000011111100000; //imm[10:5]
        int maskimm4  =   0b00000000000000000001000000000000; //imm[12]

        int vetor = ((data->opcode & maskupcode) | ((data->imm & maskimm1) >> 4) | ((data->imm & maskimm2) << 7) | ((data->funct3 & maskfunc3) << 12) | ((data->rs1 & maskrs1) << 15) | ((data->rs2 & maskrs2) << 20) | ((data->imm & maskimm3) << 20) | ((data->imm & maskimm4) << 19));
    ...
    if (data->type == 4)
    {
        int maskupcode = 0b00000000000000000000000001111111;
        int maskrd =     0b00000000000000000000000000011111;
        int maskimm =    0b00000000000011111111111111111111;

        int vetor = ((data->opcode & maskupcode) | ((data->rd & maskrd) << 7) | ((data->imm & maskimm) << 12));
        hex_code(vetor);
    }
    ...
    if (data->type ==  5)
    {
        int maskupcode =0b00000000000000000000000001111111;
        int maskrd =    0b00000000000000000000000000011111;
        int maskimm1 =  0b00000000000011111111000000000000; //imm[19:12]
        int maskimm2 =  0b00000000000000000000100000000000; //imm[11]
        int maskimm3 =  0b00000000000000000000011111111110; //imm[10:1]
        int maskimm4 =  0b00000000000100000000000000000000; //imm[20]

        int vetor = ((data->opcode & maskupcode) | ((data->rd & maskrd) << 7) | ((data->imm & maskimm1)) | ((data->imm & maskimm2) << 9) | ((data->imm & maskimm3) << 20 ) | ((data->imm & maskimm4) << 11));
        hex_code(vetor);
    }
